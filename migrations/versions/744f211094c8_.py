...
def upgrade():
    ...
    sa.Column('pay_frequecy', sa.String(length=10), nullable=True),
    sa.Column('pending_frequency', sa.String(length=10), nullable=True),
    ...
    sa.Column('ppt_Pay', sa.Numeric(precision=10, scale=2), nullable=True),
    # sa.Column('ppt_Hours', sa.Integer(), nullable=True),
    sa.Column('ppt_Hours', sa.Numeric(precision=10, scale=1), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
